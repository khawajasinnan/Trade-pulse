...
export default function TradeModal({ isOpen, onClose, onSuccess, defaultCurrency = 'EUR/USD' }: TradeModalProps) {
    ...
    return (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fade-in">
            <Card variant="glass" className="max-w-lg w-full max-h-[90vh] overflow-y-auto">
                {/* Header */}
                ...
                <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <button
                                ...
                                className={`py-3 px-4 rounded-xl font-semibold transition-all flex items-center justify-center gap-2 ${tradeType === 'BUY'
                            ...
                            <button
                                ...
                                className={`py-3 px-4 rounded-xl font-semibold transition-all flex items-center justify-center gap-2 ${tradeType === 'SELL'
                    ...
                    <div>
                        ...
                        <select
                            ...
                            required
                            className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-primary-500/20 focus:border-primary-500 transition bg-white font-medium"
                        >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            step="1"
                            placeholder="1000"
                            className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-primary-500/20 focus:border-primary-500 transition bg-white font-medium text-lg"
                        />
                    </div>
                    ...
                    <div className="flex gap-3 pt-2">
                        <button
                            type="button"
                            onClick={onClose}
                            className="flex-1 px-6 py-3 border-2 border-gray-300 rounded-xl hover:bg-gray-50 font-semibold transition currency-cursor"
                        >
                            Cancel
                        </button>
                        <button
                            ...
                            className={`flex-1 px-6 py-3 rounded-xl font-semibold transition shadow-lg currency-cursor ${tradeType === 'BUY'
